        ...
        <div className="grid items-center gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-24">
          <ScrollReveal>
            <div className="relative">
              <FlowerOrnament className="pointer-events-none absolute -left-2 -top-4 h-16 w-16 opacity-30 sm:-left-6 sm:-top-6 sm:h-24 sm:w-24 sm:opacity-40" />
              <div
                className="relative mx-auto aspect-[4/5] max-h-[min(70vh,24rem)] w-full max-w-md overflow-hidden sm:max-h-none sm:max-w-none"
                style={{ borderRadius: "1.25rem 2.5rem 1.25rem 1.25rem", boxShadow: "var(--shadow-lg)" }}
              >
                <Image
              ...
              />
              <p className="font-accent mt-4 text-center text-xl text-primary sm:mt-6 sm:text-2xl md:text-3xl lg:text-left">
          ...
          <ScrollReveal delay={150}>
            <p className="font-accent text-xl leading-snug text-primary sm:text-2xl md:text-[1.75rem]">
              Hallo, ich bin Lisa — die Gründerin der Panda-Bande.
            </p>
            <p className="mt-5 text-base leading-relaxed text-text-secondary sm:mt-8 sm:text-lg md:text-xl md:leading-9">
            ...
            <p className="mt-4 text-base leading-relaxed text-text-secondary sm:mt-6 sm:text-lg md:text-xl md:leading-9">
            ...
            <div className="mt-8 grid gap-4 sm:mt-12 sm:grid-cols-2 sm:gap-5">
              {[
                ...
                <div
                  key={item.label}
                  className="rounded-[var(--radius-card-mobile)] border border-border/60 bg-bg-secondary/50 p-5 shadow-sm sm:rounded-[var(--radius-card)] sm:p-7"
                >
            ...
            <Button href="#kontakt" size="lg" className="mt-8 w-full shadow-lg sm:mt-12 sm:w-auto">
              Lernt uns kennen
            </Button>
          </ScrollReveal>
        </div>
