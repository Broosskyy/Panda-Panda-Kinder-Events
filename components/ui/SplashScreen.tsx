...
export function SplashScreen({ tagline = BRAND.splashTagline }: SplashScreenProps) {
  ...
  return (
    <div className={`splash-screen ${fadeOut ? "splash-screen-fade-out" : ""}`} role="presentation" aria-hidden={fadeOut}>
      <div className="splash-screen-content">
        <div className="splash-logo-wrap">
          <Logo context="splash" linked={false} className="justify-center" priority />
        </div>
