...
export const ADMIN_MSG = {
  ...
  reviewPublished: "✓ Bewertung veröffentlicht — jetzt auf der Website sichtbar.",
  reviewSaved: "✓ Bewertung gespeichert.",
  reviewDeleted: "✓ Bewertung gelöscht.",
  reviewRequestSent: "✓ Bewertungsanfrage gesendet.",
  teamVisible: "✓ Auf der Website sichtbar.",
  teamHidden: "✓ Von der Website ausgeblendet.",
  ...
  testEmailSent: "✓ Test-E-Mail wurde erfolgreich gesendet.",
