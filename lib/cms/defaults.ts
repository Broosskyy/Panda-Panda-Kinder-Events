...
export const DEFAULT_SITE_SETTINGS: SiteSettingsBundle = {
  ...
  email: {
    ...
    branding: {
      ...
      replyTo: DEFAULT_COMPANY_EMAIL,
      website: SITE_URL_PLACEHOLDER,
      adminEmail: DEFAULT_COMPANY_EMAIL,
      defaultCtaUrl: SITE_URL_PLACEHOLDER,
      logoWidth: 140,
      logoHeight: 0,
      logoPaddingTop: 32,
      logoPaddingBottom: 16,
      brandDisplayName: siteConfig.name,
      slogan: siteConfig.tagline,
      showBrandName: true,
      showSlogan: true,
      showLogo: true,
      ...
      darkPrimaryColor: "#8a9a5a",
      darkSecondaryColor: "#8a9a5a",
      darkTextColor: "#f4f1ea",
      darkTextMutedColor: "#b8b5ad",
      darkBorderColor: "#3d3d38",
      darkAccentColor: "#33332f",
      darkButtonColor: "#8a9a5a",
