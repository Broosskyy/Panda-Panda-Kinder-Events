  ...
  return (
    <>
      ...
      <main id="main-content" className="public-main">
        <Hero hero={settings.hero} about={settings.about} trustBadges={settings.trustBadges} />
        ...
        <Contact contact={settings.contact} footer={settings.footer} heading={settings.sections.contact} />
      </main>
